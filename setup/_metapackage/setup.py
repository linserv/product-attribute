...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo-addon-pos_product_cost_security>=16.0dev,<16.1dev',
        ...
        'odoo-addon-product_category_description>=16.0dev,<16.1dev',
        ...
        'odoo-addon-product_pricelist_margin>=16.0dev,<16.1dev',
        ...
        'odoo-addon-product_supplierinfo_import_by_barcode>=16.0dev,<16.1dev',
        'odoo-addon-product_supplierinfo_import_by_barcode_margin>=16.0dev,<16.1dev',
        'odoo-addon-product_supplierinfo_revision>=16.0dev,<16.1dev',
        'odoo-addon-product_supplierinfo_standard_price>=16.0dev,<16.1dev',
        ...
        'odoo-addon-purchase_product_template_tags>=16.0dev,<16.1dev',
