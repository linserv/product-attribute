...
[product_attachment_zipped_download](product_attachment_zipped_download/) | 15.0.1.0.0 | [![victoralmau](https://github.com/victoralmau.png?size=30px)](https://github.com/victoralmau) | Product Attachment Zipped Download
...
[product_code_unique](product_code_unique/) | 15.0.1.0.2 |  | Set Product Internal Reference as Unique
...
[product_secondary_unit](product_secondary_unit/) | 15.0.2.0.6 | [![sergio-teruel](https://github.com/sergio-teruel.png?size=30px)](https://github.com/sergio-teruel) | Set a secondary unit per product
[product_sequence](product_sequence/) | 15.0.2.1.1 |  | Product Sequence
[product_state](product_state/) | 15.0.1.2.0 | [![emagdalenaC2i](https://github.com/emagdalenaC2i.png?size=30px)](https://github.com/emagdalenaC2i) | Module introducing a state field on product template
...
[product_variant_attribute_name_manager](product_variant_attribute_name_manager/) | 15.0.1.1.0 | [![JordiMForgeFlow](https://github.com/JordiMForgeFlow.png?size=30px)](https://github.com/JordiMForgeFlow) | Manage how to display the attributes on the product variant name.
